...
import com.elghallali.ebook.utility.MailConstructor;
import com.elghallali.ebook.utility.MoroccoStatesConstants;
...
public class HomeController {
    ...
    public String register(HttpServletRequest request, @ModelAttribute("email") String userEmail,
    ...
    public String myProfile(Model model, Principal principal) {
        ...
        List<String> stateList = MoroccoStatesConstants.listOfMoroccoStatesCode;
    ...
    public String listOfShippingAddresses(Model model, Principal principal, HttpServletRequest request) {
        ...
        return "profile/userShipping";
    }

    @RequestMapping("/listOfOrders")
    public String listOfOrders(Model model, Principal principal, HttpServletRequest request) {
        User user = userService.findByUsername(principal.getName());
        ShoppingCart shoppingCart = user.getShoppingCart();
        List<CartItem> cartItemList = cartItemService.findByShoppingCart(shoppingCart);
        model.addAttribute("cartItemList", cartItemList);
    ...
    public String orderDetail(@RequestParam("id") Long orderId, Principal principal, Model model) {
        ...
        if (order.getUser().getId() != user.getId()) {
            ...
            List<CartItem> orderCartItemList = cartItemService.findByOrder(order);
            model.addAttribute("orderCartItemListOrder", orderCartItemList);
            model.addAttribute("user", user);
